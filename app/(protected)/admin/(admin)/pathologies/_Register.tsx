"use client";
import { addNewPathology } from "@/data/admins";
...
export default function Register({ changed, setChanged }: any) {
  ...
  const handleSubmit = async () => {
    ...
    const newPATHOLOGY = await addNewPathology(pathology);
    ...
    setGender("");
    setChanged(!changed)
    toast("PATHOLOGY added successfully");
  };
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-2">
        <h3 className="font-bold text-lg">Add PATHOLOGY</h3>
